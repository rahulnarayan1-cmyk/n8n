...
const { runOpenRouter } = require('../model-gateway/openrouter-adapter');
...
const ARSPL_OUTPUT = path.join(
  ROOT,
  'output',
  'gate5-nemotron-ultra-arspl-10.json'
);

const NIRMAN_OUTPUT = path.join(
  ROOT,
  'output',
  'gate5-nemotron-ultra-nirman-10.json'
);
...
async function enrichOne(kind, index, lead) {
  ...
  try {
    const response = await runOpenRouter({
      model: MODEL,
      messages: [
        {
          role: 'system',
...
async function main() {
  console.log('==========================================');
  console.log('GATE 5 NEMOTRON CHALLENGER — START');
  console.log('==========================================');
  ...
  console.log();
  console.log('==========================================');
  console.log('GATE 5 NEMOTRON CHALLENGER — SUMMARY');
  console.log('==========================================');
  console.log(
